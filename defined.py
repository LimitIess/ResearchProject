...
LINKS = ["http://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/api/v1/sv/A_Folkhalsodata/H_Sminet/covid19/falldata/acov19DAG.px"]
regions_dict_acov19dag = {'00': 'Riket', '10': 'Blekinge', '20': 'Dalarna', '09': 'Gotland', '21': 'Gävleborg','13': 'Halland', '23': 'Jämtland', '06': 'Jönköping', '08': 'Kalmar', '07': 'Kronoberg', '25': 'Norrbotten', '12': 'Skåne', '01': 'Stockholm', '04': 'Södermanland', '03': 'Uppsala', '17': 'Värmland', '24': 'Västerbotten', '22': 'Västernorrland', '19': 'Västmanland', '14': 'Västra Götaland', '18': 'Örebro', '05': 'Östergötland'}

#ccov19kon had different regions for halland
regions_dict_ccov19Kon = {'00': 'Riket', '10': 'Blekinge', '20': 'Dalarna', '09': 'Gotland', '21': 'Gävleborg',"11":"Halland", '23': 'Jämtland', '06': 'Jönköping', '08': 'Kalmar', '07': 'Kronoberg', '25': 'Norrbotten', '12': 'Skåne', '01': 'Stockholm', '04': 'Södermanland', '03': 'Uppsala', '17': 'Värmland', '24': 'Västerbotten', '22': 'Västernorrland', '19': 'Västmanland', '14': 'Västra Götaland', '18': 'Örebro', '05': 'Östergötland'}
...
categories_to_skip = ["Antal fall per 10 000 inv", "Antal intensivvårdade fall per 100 000 inv", "Antal intensivvårdade per 100 000 inv", "Antal fall per 100 000 inv", "Antal avlidna per 100 000 inv"]
gender_suffix_dict = {"k": "Kvinnor", "m": "Män", "s": "Uppgift om kön saknas"}
#sort by reverse order using lambda to convert to int
file_names = os.listdir("data/20230828")
folders = os.listdir("data")
excel_2021_2020 = os.listdir("excel/2021_2020")
...
#Acov
#"http://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/api/v1/sv/A_Folkhalsodata/H_Sminet/covid19/falldata/acov19DAG.px"
"""
json_question = {        
    "query": [
            {
